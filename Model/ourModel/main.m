...
load('yahoo_user.mat')
load('yahoo_random.mat');
out3 = ourModel(train,test,'Method','MCP','lr',5*1e-9,'lrT',2*1e-9,'maxIter',3000);
...
load('yahoo_user.mat')
load('yahoo_random.mat');
out7 = ourModel(train,test,'Method','MCC','lr',5*1e-9,'lrT',2*1e-9,'maxIter',3000);
%% Coat Shopping Dataset - MCC
load('coat_user.mat')
load('coat_random.mat');
out8 = ourModel(train,test,'m',290,'n',300,'Method','MCC','lr',5*1e-9,'lrT',1e-9,'maxIter',381);